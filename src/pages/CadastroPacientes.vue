...
if (pacienteEditandoId.value) {
const index = pacientes.findIndex((p) => p.id === pacienteEditandoId.value)

if (index !== -1) {
    pacientes[index] = {
    ...paciente.value,
    id: pacienteEditandoId.value,
    }
}
...
localStorage.setItem('saudeDiaPacientes', JSON.stringify(pacientes))
